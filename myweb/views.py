...
class ProjectsView(ListView):
    template_name = "myweb/projects.html"
    model = Projects
...
class FeedBackView(View):
    def get(self, request):
        form = FeedBackForm()
        return render(request, "myweb/feedback.html", {
            "form": form
        })
...
class AllFeedbackView(ListView):
    template_name = "myweb/every_feedback.html"
    model = FeedBack
...
def thankyou(request):
    return render(request, "myweb/submited.html")